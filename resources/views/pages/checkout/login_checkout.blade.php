...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page">Đăng ký hoặc đăng nhập</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- page heading-->
        <h2 class="page-heading">
            <span class="page-heading-title2">Đăng ký hoặc đăng nhập</span>
        </h2>
        <!-- ../page heading-->
        <div class="page-content">
            <div class="row">
                ...
                <div class="box-authentication">
                        ...
                        {{ csrf_field() }}
                            <label for="emmail_login">Tài khoản</label>
                            <input name="email_account" id="emmail_login" type="text" class="form-control" placeholder="Email address">
                            <label for="password_login">Mật khẩu</label>
                            <input name="password_account" id="password_login" type="password" class="form-control" placeholder="Password">
                ...
                <div class="col-sm-6">
                    <div class="box-authentication">
                        ...
                        {{ csrf_field() }}
                            <label for="emmail_login">Họ và tên</label>
                            <input name="customer_name" id="emmail_login" type="text" class="form-control" >
                            <!-- <label for="password_login">Địa chỉ email</label>
                            <input name="password_account" id="password_login" type="password" class="form-control" > -->
                            <label for="emmail_login">Tài khoản</label>
                            <input name="customer_email" id="emmail_login" type="text" class="form-control" placeholder="Email address">
                            <label for="password_login">Mật khẩu</label>
                            <input name="customer_password" id="password_login" type="password" class="form-control" placeholder="Password">
                            <label for="emmail_login">Phone</label>
                            <input name="customer_phone" id="emmail_login" type="text" class="form-control" >
