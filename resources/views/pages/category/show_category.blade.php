...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            ...
            <span class="navigation_page">{{$name->category_name}}</span>
            @endforeach
        </div>
        <!-- ./breadcrumb -->
        <!-- row -->
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                @foreach($category_name as $key => $name)
                    <h2 class="page-heading">
                        <span class="page-heading-title">{{$name->category_name}}</span>
                    </h2>
                    @endforeach
                    ...
                    @foreach($category_by_id as $key => $product)
                        <li class="col-sx-12 col-sm-4" style="width:300; height:480">
                        ...
                        <input type="hidden" value="1" class="cart_product_qty_{{$product->product_id}}">
                            <div class="product-container">
                                ...
                                <div class="left-block">
                                    ...
                                    <button type="button" class="btn btn-fefault add-to-to-cart" data-id="{{$product->product_id}}"
                                        name="add-to-cart">
